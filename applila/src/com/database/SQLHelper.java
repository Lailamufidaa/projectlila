...
public Cursor checkAkun(String name){
	//memasukan 1 parameter jika nama yang dimasukkan memneiliki kesamaan dengan data yang sudsh disimpan 
	//anti duplikasi 
	SQLiteDatabase db = this.getReadableDatabase();
    Cursor res =  db.rawQuery("select = froe "+new Users().TABLE_NAME+"where "
